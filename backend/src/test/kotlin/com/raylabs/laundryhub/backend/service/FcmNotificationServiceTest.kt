...
class FcmNotificationServiceTest {
    ...
    @Test
    fun `service can be constructed with custom environment and normalizes credentials`() {
        // Clear existing apps to force initialization path execution
        ...
        val customEnv = mapOf("GOOGLE_SERVICE_ACCOUNT_JSON" to dummyJson)
        val service = FcmNotificationService(customEnv)
        assertNotNull(service)
